    ...
    <div class=" row">
        <div class="col-md-4 ">
            <div class="card w-100">
                ...
                <div class="card-body ">
                    ...
                    <form action="index.php?action=user&act=profile" method="post" enctype="multipart/form-data" style="background:none;">
        ...
        <div class="col-md-8  p-2" style="border-radius: 11px;background: #ededed;box-shadow:  35px 35px 70px #c9c9c9, -35px -35px 70px #ffffff;">
            <div class="container">
                ...
                <form action="index.php?action=user&act=profile" method="post">
...
<script>
    ...
    const inputs = document.querySelectorAll("#content > div > div > div > div.col-md-8.p-2 > div > form > div > input");
    inputs.forEach((e) => {
